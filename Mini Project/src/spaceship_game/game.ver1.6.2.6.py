...
# 게임 루프 정의
def runGame():
    global gamepad, clock, background, fighter, missile, explosion, missile_interval, missile_direction, missile_group, bg_y1, bg_y2, cooldown_time, last_frame_time
    ...
    # 마지막 프레임 시간 초기화
    last_missile_time = pygame.time.get_ticks() / 1000
